...
for name in cpo-daily.config.toml cpo-terra.config.toml cpo-quality.config.toml cpo-ultra.config.toml cpo-version; do rm -f "$PROFILE_DST/$name"; done
